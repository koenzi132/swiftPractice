...
//          (대입문으로 값을 복사하면, 실제 값이 아닌 주소값이 복사 됨.)
...
print(myStruct.age)
print(myStruct2.age)
// (myStruct와 myStruct2는 서로 다른 메모리 공간에 할당됨.)

// 클래스의 객체 생성
let myClass = MyClass()
var myClass2 = myClass // myClass의 주소값(ex-0x1000번지)이 정수로 전달됨.
myClass2.age = 33
print(myClass.age)
print(myClass2.age)
