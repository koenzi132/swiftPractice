...
// String : 스위프트 구조체 타입
// NSString : NS계열 클래스 타입 (Objective C)
 
// 값 복사를 간편하게 하기 위해서 String을 사용할 것을 권장!
 
// NSString을 String으로 변환해서 사용 가능
...
let text = "abc"
// print(text[0]) // 배열처럼 인덱스로 바로 접근 불가
...
// 문자열 변수
let char2: Character = "A" // 문자형 변수는 쌍따옴표만 사용 가능
...
var tempFloat = myIntNumber.floatValue // 필요할 때 이런 식으로 원하는 타입으로 뽑아 쓸 수 있다
